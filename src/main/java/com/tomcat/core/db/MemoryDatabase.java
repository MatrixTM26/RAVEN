...
public final class MemoryDatabase extends TeamDatabase {
    ...
    public MemoryDatabase() {
        ...
        Admin.put("Role", OperatorRole.SUPER_ADMIN.name());
    ...
    public OperatorRole GetOperatorRole(String Username) {
        Map<String, Object> Op = Operators.get(Username);
        return Op == null ? OperatorRole.MEMBER : OperatorRole.FromString(Op.get("Role").toString());
    }
    ...
    public List<Map<String, Object>> GetOperators() {
        return Operators.values()
            ...
            .map(Op -> {
                ...
                Safe.put("LastSeen", LastSeenMap.getOrDefault(Safe.get("Username").toString(), "Never"));
                return Safe;
            })
            .collect(Collectors.toList());
    }
