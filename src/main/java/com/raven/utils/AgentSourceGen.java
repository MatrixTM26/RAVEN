...
/**
 * Generates agent source code for all supported languages.
 * Used by both Start.java (CLI -a flag) and WebApp (/api/agent/gen endpoint).
 */
public final class AgentSourceGen {
    ...
    public static String Generate(String Lang, String Id, String Host, int Port, boolean Mtls, boolean Persist,
            boolean Hide) {
